...
| 2026-07-25-03-arch | 2026-07-25 | re-arch | PostGIS 리포지토리 구현 + 마이그레이션 실검증 | review-required | working | herdr 복구 후 tell.py 로 하달. 지시서 작성 완료 |
| 2026-07-25-04-data | 2026-07-25 | re-data | 세율 채우기(출처 필수) + 수집 실행 준비 | review-required | working | 자금계산 503 해소가 최우선. 지시서 작성 완료 |
| 2026-07-25-05-review | 2026-07-25 | re-review | CR-004~006/SR-004~005 독립 재감사 (SR4-2 우회 시도) | none | working | PM 자체검토 확정/반려. 지시서 작성 완료 |
| 2026-07-25-06-domain | 2026-07-25 | re-domain | 입지 분석 로직 + 동별 추정 구체화 | review-required | working | location_finding 스텁 대체. 지시서 작성 완료 |
